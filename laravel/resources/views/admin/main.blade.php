  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{route('Admin')}}" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">TBS Admin</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Nguyễn Hữu Long</span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>Nguyễn Hữu Long</h6>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('addonhang')}}">
              <i class="bi bi-circle"></i><span>Đơn đặt hàng</span>
            </a>
          </li>
          <li>
            <a href="{{route('orders.dondathang')}}">
              <i class="bi bi-circle"></i><span>Đơn hàng đã duyệt</span>
            </a>
          </li>
          <li>
            <a href="#">
